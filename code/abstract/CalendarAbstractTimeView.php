...
abstract class CalendarAbstractTimeView extends CalendarAbstractView
{
	...
	function setTimePeriod(CalendarTimePeriod $timePeriod)
	{
		$this->timePeriod = $timePeriod;
	}
	function setSubPeriodsLength(CalendarTime $subPeriodsLength)
	{
	...
	function setTimeTitle($timeTitle)
	{
	...
	function setTimeClass($timeClass)
	{
